...
from lib.train.dataset import UAV123
...
def names2datasets(name_list: list, settings, image_loader):
    ...
    for name in name_list:
        ...
        if name == "UAV123":
            if settings.use_lmdb:
                print("Building UAV123 from lmdb")
                #datasets.append(UAV123_lmdb(settings.env.uav123_lmdb_dir, image_loader=image_loader))
            else:
                datasets.append(UAV123(settings.env.uav123_dir, image_loader=image_loader))
    return datasets
